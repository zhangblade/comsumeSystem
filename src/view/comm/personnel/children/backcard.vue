	...
	export default {
		...
		methods: {
            getData(){
                ...
                Interface[this.exportTypeKey].backcard_findById(req).then(res=>{
                    if (res.status == 200) {
                        ...
                        this.publishTime = res.data.bBegintime ? res.data.bBegintime.split(' ')[0] + '  ~  ' + res.data.bEndtime.split(' ')[0] : ''
                    }
                })
            },
            handleSubmit(validInfo){
                ...
                this.$refs[validInfo].validate((valid) => {
                    if (valid) {
                        ...
                        Interface[this.exportTypeKey].backcard_submit(this.itemData).then(res=>{
                            if (res.status == 200) {
