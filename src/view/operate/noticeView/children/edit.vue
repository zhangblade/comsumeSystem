            ...
            getEditItemData(){
                ...
                Interface[this.exportTypeKey].findById(req).then(res=>{
                    if (res.status == 200) {
                        ...
                        this.previewList = JSON.parse(res.data.imageUrls)
                        this.companyList = res.data.receiver ? JSON.parse(res.data.receiver) : []
                        this.itemData.TimeRange = [res.data.validStartTime, res.data.validEndTime]
                    }else{
